...
func (blockExec *BlockExecutor) applyBlock(state State, blockID types.BlockID, block *types.Block) (State, error) {
	...
	//for i, linTx := range abciResponse.TxResults {
	//	fmt.Println("数据", i, linTx.GasUsed, linTx.GasWanted, linTx.Log)
	//} //xiugai

	blockExec.logger.Info(
		"最终块", //"finalized block",//"xiugai"
		"height", block.Height,
...
func (blockExec *BlockExecutor) Commit(
	...
	blockExec.logger.Debug(
		"提交状态", //committed state Info//"xiugai"
		"height", block.Height,

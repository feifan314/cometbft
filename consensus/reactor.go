...
func (conR *Reactor) AddPeer(peer p2p.Peer) {
	...
	//go conR.gossipDataRoutine(peer, peerState)  //数据//xiugai200
	//go conR.gossipVotesRoutine(peer, peerState) //投票//xiugai200
	go conR.queryMaj23Routine(peer, peerState) //如果一个对等方声称它对给定的blockKey拥有2/3的多数，请调用此命令。
